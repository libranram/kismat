...
- **Integrator**: Water-dominant traits. Harmonizing catalyst, high emotional intelligence.
...
3. Run `npm install` and `npm run dev` to start the local development server.
